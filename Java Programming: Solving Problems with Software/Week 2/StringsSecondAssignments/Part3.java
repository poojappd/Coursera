 ...
 break;}
  ...
  currIndex=dna.indexOf(Dna)+Dna.length();
    ...
    public void testCountGenes(){
        System.out.println(countGenes("ATGCAAVAATAATAGTGAATGRTTTAGTAATGA"));
        System.out.println(countGenes("ATGCAAVAATAAATGTAGTGAATGRTTTAGTAATGA"));
        System.out.println(countGenes("ATGGATTAGTAAGAAAtG"));
    }
